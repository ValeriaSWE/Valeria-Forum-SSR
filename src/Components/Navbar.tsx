  ...
  function NavBarIcons() {
    ...
    function ProfileDropdownMenu() {
      ...
      function toggleDarkmode() {
        let lightModeOn = "on" as string // localStorage.getItem('lightmode') == "off" ? "on" : "off" || "on"
        ...
        $('#dark-code-styling').attr('disabled', (lightModeOn == "on").toString())
        $('#light-code-styling').attr('disabled', (lightModeOn == "off").toString())
